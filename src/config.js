...
export const restaurentList=[
  ...
  
  {
    ...
    cityState: "1",
    address: "1st floor,Site bearing No. 59 carved out of Sy. No. 17 of Kathriguppe Village, situated at the Bhavani Housing Co-op Society Ltd., Layout in Block No. T Banashankari 3rd Stage, Bangalore,560085",
    locality: "3rd Stage",
    parentId: 239281,
    unserviceable: false,
    veg: false,
    ...
    thirdPartyVendor: "",
    adTrackingID: "cid=5684021~p=1~eid=00000185-9c11-6b6e-22d1-8aea0064016e",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    uuid: "ec3e4286-116f-413a-8749-8b4a5b564d5f",
    city: "1",
    area: "Rajarajeshwari Nagar",
    totalRatingsString: "100+ ratings",
    cloudinaryImageId: "ptaqpk684eetpyb8ukg8",
    cuisines: [
    "North Indian",
    "Beverages"
    ],
    ...
    slugs: {
    restaurant: "shyamji's-chole-bhature-rajarajeshwari-nagar-rajarajeshwari-nagar",
    city: "bangalore"
    },
    cityState: "1",
    address: "NO 72 60 FEET MAIN ROAD BEML 5TH STAGE RAJARAJESWARI NAGAR CHANNASANDRA VILLAGE, B.B.M.P West, Karnataka-560098",
    locality: "5th Stage",
    parentId: 255424,
    unserviceable: false,
    veg: false,
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5702812~p=4~eid=00000185-9c11-6b6e-22d1-8aeb00640424",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    id: "503943",
    name: "Istah Shawarma",
    uuid: "e1143ab0-a289-4a4d-8bca-7023152424ae",
    city: "1",
    area: "Banashankari",
    totalRatingsString: "100+ ratings",
    cloudinaryImageId: "101c78a76e6f74047e4b3821c41fb1b6",
    cuisines: [
    "Arabian",
    "Lebanese",
    "Snacks",
    ...
    lastMileTravel: 2.5,
    slugs: {
    restaurant: "istah---shawarma-and-biryani-banashankari-banashankari",
    city: "bangalore"
    },
    cityState: "1",
    address: "NO 59,SY NO 17,KATHRIGUPPEVILLAGE,BHAVANI HOUSING CO-OPERATIVE SOCIETY LTD LAYOUT,BLOCK T , BANASHANKARI 3RD STAGE ,BANGALORE , Karnataka, 560085",
    locality: "3rd Stage",
    parentId: 3518,
    unserviceable: false,
    veg: false,
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5683590~p=7~eid=00000185-9c11-6b6e-22d1-8aec00640730",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5700375~p=10~eid=00000185-9c11-6b6e-22d1-8aed00640a04",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    id: "644869",
    name: "Burger King",
    uuid: "7cebfab8-4a1a-4e7e-8ecd-f5ebd5ab35b2",
    city: "1",
    area: "Vijayanagar",
    ...
    lastMileTravel: 2,
    slugs: {
    restaurant: "burger-king-global-divinity-mall-vijayanagar",
    city: "bangalore"
    },
    cityState: "1",
    ...
    type: "F",
    id: "402907",
    name: "Maharaja Military Canteen",
    uuid: "61017ec7-3f03-40cd-867a-f4985f0a069d",
    city: "1",
    area: "Banashankari",
    totalRatingsString: "100+ ratings",
    cloudinaryImageId: "v6k86anp7keaxs1ncjpa",
    cuisines: [
    "South Indian"
    ],
    tags: [ ],
    ...
    lastMileTravel: 3.5,
    slugs: {
    restaurant: "maharaja-military-canteen-banashankari-banashankari",
    city: "bangalore"
    },
    cityState: "1",
    address: "NO.30/33.22nd main Road,BSK 2nd stage,Bangalore-560061",
    locality: "2nd Stage",
    parentId: 21056,
    unserviceable: false,
    veg: false,
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5649926~p=28~eid=00000185-9c11-6b6e-22d1-8af300641c7d",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5700320~p=16~eid=00000185-9c11-6b6e-22d1-8aef00641048",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    id: "22195",
    name: "Subway",
    uuid: "c83978c9-bb01-4a2b-b15a-df522ba5e7b3",
    city: "1",
    area: "Rajarajeshwari Nagar",
    totalRatingsString: "100+ ratings",
    cloudinaryImageId: "twddkzbx4eroiwcn7sgw",
    cuisines: [
    "Salads",
    "Snacks",
    "Desserts",
    ...
    lastMileTravel: 4,
    slugs: {
    restaurant: "subway-mahadevpura-mahadevpura",
    city: "bangalore"
    },
    cityState: "1",
    address: "NO 325, G FLOOR, LAKSHMI RAM MANSION, NEAR 5TH STG BUS STOP, 60 FEET ROAD, JAWAHARLAL NEHRU ROAD, BEML 5TH STAGE, RAJARAJESHWARI NAGAR, BANGALORE, B.B.M.P West, Karnataka-560098",
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5693604~p=19~eid=00000185-9c11-6b6e-22d1-8af000641338",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
